...
function coerceObservable(data) {
  if (!(0, import_rxjs4.isObservable)(data)) {
    return (0, import_rxjs4.of)(data);
  }
  return data;
}
...
var BreakpointObserver = class _BreakpointObserver {
  constructor(_mediaMatcher, _zone) {
    ...
    this._destroySubject = new import_rxjs6.Subject();
  }
  ...
  observe(value) {
    ...
    let stateObservable = (0, import_rxjs6.combineLatest)(observables);
    stateObservable = (0, import_rxjs6.concat)(stateObservable.pipe((0, import_operators4.take)(1)), stateObservable.pipe((0, import_operators4.skip)(1), (0, import_operators4.debounceTime)(0)));
  ...
  _registerQuery(query2) {
    ...
    const queryObservable = new import_rxjs6.Observable((observer) => {
...
var DialogRef = class {
  constructor(overlayRef, config) {
    ...
    this.config = config;
    this.closed = new import_rxjs8.Subject();
...
var Dialog = class _Dialog {
  ...
  constructor(_overlay, _injector, _defaultOptions, _parentDialog, _overlayContainer, scrollStrategy) {
    ...
    this._afterAllClosedAtThisLevel = new import_rxjs8.Subject();
    this._afterOpenedAtThisLevel = new import_rxjs8.Subject();
    this._ariaHiddenElements = /* @__PURE__ */ new Map();
    this.afterAllClosed = (0, import_rxjs8.defer)(() => this.openDialogs.length ? this._getAfterAllClosed() : this._getAfterAllClosed().pipe((0, import_operators6.startWith)(void 0)));
...
var DateAdapter = class {
  constructor() {
    this._localeChanges = new import_rxjs9.Subject();
...
var MatDialogRef = class {
  constructor(_ref, config, _containerInstance) {
    ...
    this._afterOpened = new import_rxjs10.Subject();
    this._beforeClosed = new import_rxjs10.Subject();
...
var MatDialog = class _MatDialog {
  ...
  constructor(_overlay, injector, location, _defaultOptions, _scrollStrategy, _parentDialog, _overlayContainer, _animationMode) {
    ...
    this._parentDialog = _parentDialog;
    this._openDialogsAtThisLevel = [];
    this._afterAllClosedAtThisLevel = new import_rxjs10.Subject();
    this._afterOpenedAtThisLevel = new import_rxjs10.Subject();
    this.dialogConfigClass = MatDialogConfig;
    this.afterAllClosed = (0, import_rxjs10.defer)(() => this.openDialogs.length ? this._getAfterAllClosed() : this._getAfterAllClosed().pipe((0, import_operators8.startWith)(void 0)));
